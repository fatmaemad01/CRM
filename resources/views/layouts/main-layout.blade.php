    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="{{asset('img/user.jpg')}}" class="mr-2" alt="logo" /></a>
                ...
                <ul class="nav">
                    ...
                    <li class="d-flex justify-content-center m-4">
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link class="btn btn-inverse-danger btn-fw" :href="route('logout')" onclick="event.preventDefault();
